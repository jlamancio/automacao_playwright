...
//             await expect(
//                 page.getByText('Checkout: Your Information', { exact: true }),
//             ).toBeVisible();
...
//             const shippInformation = page.locator(
...
//             await expect(
//                 page.getByText('Shipping Information:', { exact: true }),
//             ).toBeVisible();
//             await expect(shippInformation).toHaveText(
//                 'Free Pony Express Delivery!',
//             );

//             await expect(
//                 page.getByText('Price Total', { exact: true }),
//             ).toBeVisible();
...
//             const burgerMenuButton = await page.locator(
...
//             await expect(
//                 page.getByText('Swag Labs', { exact: true }),
//             ).toBeVisible();
//         });
//     });
// });
